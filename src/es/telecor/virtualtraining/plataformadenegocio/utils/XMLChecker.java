...
public class XMLChecker {
    ...
    public XMLChecker(String _dirOrigen) {
        this.dirOrigen = _dirOrigen;

    }

    public boolean comprobarFicheroXML(String XMLtoCheck, String type) throws IOException, SAXException {
        ...
        try {
            ...
            FileInputStream xsdInput = new FileInputStream(new File(this.dirOrigen + XMLtoCheck));
